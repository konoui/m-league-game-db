...
Note: name_furigana ひらがなの名前から選手名/id を検索できる。
...
| raw_points                  | numeric                         | YES       | チームごとの games テーブルの points の合計ト                                                      |
...
event_id よりどのイベント時における情報か確認できる。特別な要件がなければシャンテン数には shanten_count を使用する。
...
| description     | varchar(255) | NO        | 反則・チョンボの詳細説明                                                                                                                                                  |
| type            | varchar(255) | NO        | 反則・チョンボの種類（"chi by mistake", "pon by mistake", "reached by mistake", "ron agari by mistake", "shortage of tiles", "too many tiles", "tsumo agari by mistake"） |
